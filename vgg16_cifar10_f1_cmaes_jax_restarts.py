...
print(out)
csv_path = (
    f"out/VGG16_CIFAR10_block_bs{block_size}_gfo_100Kfe_f1_cmaes_jax_restart5_hist.csv"
)
plt_path = (
    f"out/VGG16_CIFAR10_block_bs{block_size}_gfo_100Kfe_f1_cmaes_jax_restart5_plt.pdf"
)
df = pd.DataFrame(
    {
        "n_step": [0],
...
while FE < maxFE:
    ...
    if state.restart_state.restart_next:
        ...
        NP = state.restart_state.active_popsize
