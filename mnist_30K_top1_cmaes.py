...
if __name__ == "__main__":
    ...
    print(out)
    csv_path = f"out/{problem_name}_block_bs{block_size}_gfo_100K-fe_top1_hist.csv"
    plt_path = f"out/{problem_name}_block_bs{block_size}_gfo_100K-fe_top1_plt.pdf"
    model_path = f"out/{problem_name}_block_bs{block_size}_gfo_100K-fe_top1_model"
